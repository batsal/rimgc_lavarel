...
<head>
  ...
  <!-- bootstrap theme -->
  <link href="<?php echo e(URL::asset('css/bootstrap-theme.css')); ?>" rel="stylesheet">
  <!--external css-->
  <!-- font icon -->
  <link href="<?php echo e(URL::asset('css/elegant-icons-style.css')); ?>" rel="stylesheet" />
  ...
  <link href="<?php echo e(URL::asset('css/bootstrap-colorpicker.css')); ?>" rel="stylesheet" />
  <!-- date picker -->
  ...
  <link rel="stylesheet" href="<?php echo e(URL::asset('css/jquery-ui-1.10.4.min.css')); ?>">
