        ...
        <div class="col-lg-10">
          <section class="panel">
            ...
            <div class="col-sm-5 panel-body">
                  ...
                  <div class="col-sm-6 text-left"><?php echo e($edit -> ethnicity); ?></div>
                </div>
        ...
        <div class="col-lg-10">
          <section class="panel">
            ...
            <div class="col-sm-5 panel-body">
                  ...
                  <div class="col-sm-6 text-left"><?php echo e(date('m/d/Y',strtotime($edit -> sample_recorded_date))); ?></div>
            </div>
            <div class="col-sm-5 panel-body">
                  <div class="col-sm-6 text-right">
                    <label for="enrolled">Family member Relationship</label></div> 
                  <div class="col-sm-6 text-left"><?php echo e($edit -> subject); ?></div>
            </div>
            <div class="col-sm-5 panel-body">
                  <div class="col-sm-6 text-right">
            ...
            <div class="col-sm-5 panel-body">
                  ...
                  <div class="col-sm-6 text-left"><?php echo e($edit -> file_type_available); ?>
