 ...
 <!-- container section end -->
  ...
  <!-- jquery ui -->
  <script src="<?php echo e(URL::asset('js/jquery-ui-1.9.2.custom.min.js')); ?>"></script>

  <!--custom checkbox & radio-->
  <script type="text/javascript" src="<?php echo e(URL::asset('js/ga.js')); ?>"></script>
  <!--custom switch-->
  <script src="<?php echo e(URL::asset('js/bootstrap-switch.js')); ?>"></script>
  <!--custom tagsinput-->
  <script src="<?php echo e(URL::asset('js/jquery.tagsinput.js')); ?>"></script>

  <!-- colorpicker -->

  <!-- bootstrap-wysiwyg -->
  <script src="<?php echo e(URL::asset('js/jquery.hotkeys.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('js/bootstrap-wysiwyg.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('js/bootstrap-wysiwyg-custom.js')); ?>"></script>
 ...
 <script src="<?php echo e(URL::asset('js/bootstrap-colorpicker.js')); ?>"></script>
  <!-- ck editor -->
  <script type="text/javascript" src="<?php echo e(URL::asset('assets/ckeditor/ckeditor.js')); ?>"></script>
  <!-- custom form component script for this page-->
  <script src="<?php echo e(URL::asset('js/form-component.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.validate.min.js')); ?>"></script>

  <!-- custom form validation script for this page-->
  <script src="<?php echo e(URL::asset('js/form-validation-script.js')); ?>"></script>
  <!-- custome script for all page -->
  <script src="<?php echo e(URL::asset('js/scripts.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('js/form.js')); ?>"></script>
