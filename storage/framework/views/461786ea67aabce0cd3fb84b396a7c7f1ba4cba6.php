...
<form name="research" id="research" class="form-horizontal" method="post" role="form" action="<?php echo e(url('form')); ?>" >
      ...
      <div class="row" >
                <div class="col-lg-6 m-t">
                  <h3 class="page-header" style="margin-top: 0px;"><i class="fa fa-file-text-o"></i>IMGC Research Add New Record</h3>
                  <!-- <ol class="breadcrumb">
          ...
          <section class="head-f" style="margin-bottom: 10px;">
            ...
            <div class="col-md-offset-2">
                ...
                <div class="inline date text-left">
                  ...
                  <div class="col-lg-6">
                    <input type="text" class="form-control" id="created_date" name="created_date" value="<?php echo e(date('d/m/Y')); ?>">
                  </div>
                </div>
                  <div class="inline text-left">
                  <label for="inputPassword1" class="col-lg-3 text-left control-label">Family ID</label>
                  <div class="col-lg-6">
                    <input type="text" class="form-control" id="family_id" name="family_id" required="true" value="<?php if(old('family_id')): ?><?php echo e(old('family_id')); ?> <?php else: ?> <?php echo e($maxFamilyId); ?> <?php endif; ?>" required="true">
                  </div>
            </div>
            </div>
          </section>
            ...
            <section class="panel">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="enrolled_study_irb" 
                     name="enrolled_study_irb" value="<?php echo e(old('enrolled_study_irb')); ?>" placeholder="Enter 16-03231 ">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <label class="label_radio" for="radio-01">
                            ...
                            <?php if(old('sample') =='A'): ?> checked <?php elseif(old('sample') ==''): ?> checked <?php endif; ?> /> Affected
                      </label>
                  ...
                  <div class="radios">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="label_radio" for="radio-02">
                            ...
                            <?php if(old('sample') =='No'): ?> checked <?php elseif(old('sample') ==''): ?> checked  <?php endif; ?>/> No
                        </label>
                        <label class="label_radio" for="radio-03">
 ...
 -->
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <label for="status_affected_member" class="col-lg-4 text-right control-label">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      ...
                      value="<?php if(old('study_id')): ?><?php echo e(old('study_id')); ?> <?php else: ?> <?php echo e('RIMGCA'); ?> <?php endif; ?>" required="true">
