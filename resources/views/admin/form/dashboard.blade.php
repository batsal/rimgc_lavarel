...
@section('script')
    <!-- chartjs -->
    <script src="{{URL::asset('https://code.highcharts.com/highcharts.js')}}"></script>
    <script src="{{URL::asset('https://code.highcharts.com/modules/data.js')}}"></script>
    <script src="{{URL::asset('https://code.highcharts.com/modules/drilldown.js')}}"></script>
    <script>
