      ...
      <div class="row">
                <div class="col-lg-6">
                 ...
                 <section class="panel">
                       ...
                       <a href="{{ route('form')}}" class="btn btn-primary">View All Enrolled Subjects</a>&nbsp;&nbsp;
                  ...
                  <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                          <label for="createdBy" class="col-lg-2 control-label">Created By</label>
                          <div class="col-lg-10">
...
<<<<<<< HEAD
                              <select class="form-control  m-bot15" name="lab_used" id="lab_used">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control  m-bot15" name="race">
                                            ...
                                            <option value="06" @if("06"==$edit->race)   selected @endif>Native Hawain/Other pacific Ilander</option>
